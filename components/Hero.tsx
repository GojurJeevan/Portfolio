        ...
        >
          <div>
            ...
            >
              ...
              technologies. Focused on creating elegant solutions with clean,
              maintainable code.
            </motion.p>
          </div>
          ...
          >
            ...
            <Button size="lg" variant="outline" asChild>
              <Link href="https://drive.google.com/file/d/1zX1se_MoaK5FqTNFZbJVQH4EAOlzFj3v/view?usp=drivesdk" target="_blank">
          ...
          >
            ...
            <Link href="mailto:jeevangojur2605@gmail.com">
              <Button
                size="icon"
                variant="ghost"
                className="h-10 w-10 rounded-full"
